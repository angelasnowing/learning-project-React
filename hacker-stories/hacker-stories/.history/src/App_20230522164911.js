...
const App = () => {
  ...
  const storiesReducer = (state, action) => {
    switch(action.type){
      ...
      case "STORIES_FETCH_SUCCESS": return {data: action.payload, isLoading: false, isError: false}
      case "STORIES_FETCH_FAILURE": return {...state, isLoading: false, isError: true}
      case "REMOVE_STORY": return state.data.filter( story => story.objectID !== action.payload.objectID)
